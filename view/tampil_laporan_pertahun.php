		    	...
		    	<div class="card">
		    		...
		    		<div class="card-body " >
					    ...
					    if(isset($_POST['search'])){
		    				...
		    				?><p align="center" style="font-size: 18px;"><b>Laporan Data Penduduk Pada Periode <?php echo $periode; ?></b></p><?php
					        ...
					        <div class="table-responsive-sm">
				    			...
				    			<p align="center">
				    				...
				    				<?php echo "<a href = 'aksi/export_pertahun.php?id=".$periode."' class='btn btn-success btn-sm'><img src='../gambar/simpan.png' width='20px'> Export Excel</a>";?>
				    				<?php echo "<a href = 'aksi/cetak_pertahun.php?id=".$periode."' class='btn btn-danger btn-sm'><img src='../gambar/cetak.png' width='20px'> Cetak</a>";?>
				    			</p>
							<?php
					        }else{
