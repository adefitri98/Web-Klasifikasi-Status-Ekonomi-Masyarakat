		...
		<div class="row">
		    ...
		    <div class="col-9">
		    	<div class="card">
		    		...
		    		<div class="card-body " >
		    			<p align="center" style="font-size: 18px;"><b>Tambahkan Data Penduduk</b></p>
		    			<br>
		    			<form action="aksi/lanjutan.php" method="post">
		    				<div class="form-row">
							...
							<div class="form-row">
							  ...
							  <table align="center">
						 		...
						 		<td width="90%"></td>
						 		<td align="right"><button type="submit" class="btn btn-info btn-md">Lanjut</button></td>
						 	</table>
		    			</form>
		    		</div>
		    	</div>
