		    			...
		    			<div class="col-6" align="center">
			    			<div class="card border-info">
							    <div class="card-body" align="center">
							      ...
							      <p class="card-text">
							      	<small class="text-muted">Klik untuk melihat laporan data penduduk per-tahun </small></p>
							      <a href="laporan_pertahun.php" class="btn btn-info btn-sm">Lihat Laporan</a>
							    </div>
							</div>
						</div>
						<div class="col-6" align="center">
			    			<div class="card border-info">
							    <div class="card-body" align="center">
							      <h5 class="card-title">Laporan Per-Nama</h5>
							      <p class="card-text">
							      	<small class="text-muted">Klik untuk melihat laporan data penduduk per-nama </small></p>
							      <a href="laporan_pernama.php" class="btn btn-info btn-sm">Lihat Laporan</a>
							    </div>
							</div>
						</div>
						</div>
