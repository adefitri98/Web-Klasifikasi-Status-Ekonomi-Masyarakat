		...
		<div class="row">
		    <div class="col-9">
		    	<div class="card">
		    		...
		    		<div class="card-body " >
		    			<p align="center" style="font-size: 18px;"><b>Laporan Data Penduduk Per-Nama</b></p>
		    			<br>
		    			<form action="tampil_laporan_pernama.php" method="post">
							...
							<div class="form-group row">
								<div class="col-sm-12" align="center">
							   		<input type="submit" class="btn btn-info btn-sm" name="search" style="width: 120px;" value="Lihat">
								</div>
							</div>
		    			</form>
		    			</div>
